...
shoot()
{
  ...
  {
   outtextxy(550,40+ll,"__________");
   outtextxy(600,44+ll,"<");
  }
  a:
  for(i=i;i<300;i++)
...
welcome()
{
 ...
 setcolor(15);
 outtextxy(maxx/2-80,maxy/2-150,"WELCCOME TO ARCHERY");
